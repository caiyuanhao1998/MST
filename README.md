...
#### News
- **2022.06.14 :** Code and models have been released. This repo supports 9 learning-based methods to serve as a baseline for Spectral Compressive Imaging. The model zoo will be enlarged. 🔥
...
| :-------: | :--------: | :-------: | :--------: | :--------: | :----------: | :------------------: | :------------: |
|   [λ-Net-Net](https://ieeexplore.ieee.org/document/9010044)   |    28.53    |  0.841   |   0.3814   |   0.0588   | [Google Drive](https://drive.google.com/file/d/1DqeTNNYaIKodCQWrhclVO3bXw1r4OAxJ/view?usp=sharing) / [Baidu Disk](https://pan.baidu.com/s/1VebfZFZCNxeT44IE5GtLsg)| -/- |
